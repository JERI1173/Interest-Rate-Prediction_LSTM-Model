...
1. The dataset is loaded from a CSV file, an is normalized using the MinMaxScaler to ensure all features have values between 0 and 1, for training of the neural network.
